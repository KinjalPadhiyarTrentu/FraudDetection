        ...
        <div class="login-register" style="background-image:url(../assets/images/background/login-register.jpg);">        
            ...
            <div class="card-body">
                <form class="form-horizontal form-material" id="loginform" action="index.html">
                    <h3 class="box-title m-b-20">Report</h3>
                    ...
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-control" type="tel" required="" placeholder="Phone no">
                        </div>
                    </div>
                    <div class="form-group ">
                        <div class="col-xs-12">
                    ...
                    <div class="form-group ">
                        <div class="col-xs-12">
                        	Address <br><br><div><textarea name="Address" form=""></textarea></div>
                        </div>
                    </div>
                    <div class="form-group ">
                        <div class="col-xs-12">
                           Photo  <input class="form-control" type="file" required="" placeholder="photo">
                        </div>
                    </div>
                     <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <button class="btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light" type="submit">Add</button>
                        </div>
                    </div>
