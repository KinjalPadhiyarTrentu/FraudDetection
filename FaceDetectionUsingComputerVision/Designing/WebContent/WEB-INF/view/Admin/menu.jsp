<aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <div class="user-profile">
                    <!-- User profile image -->
                    <div class="profile-img"> <img src="AdminResources/images/1.jpg" alt="user" /> </div>
                    <!-- User profile text-->
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a class="has-arrow" href="index.jsp" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Dashboard <!-- <span class="label label-rounded label-success">5</span> --></span></a>
                        ...
                        <li>
                            <a class="has-arrow " href="#" aria-expanded="false"><i class="mdi mdi-email"></i><span class="hide-menu">Login</span></a>
                            <ul aria-expanded="false" class="collapse">
                        ...
                        <li>
                            <a class="has-arrow " href="#" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">Manage Student</span></a>
                            <ul aria-expanded="false" class="collapse">
                        ...
                        <li>
                            <a class="has-arrow " href="#" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">Manage Class</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="addClass.html">Add Class</a></li>
                                <li><a href="viewClass.html">View Class</a></li>
                              <!--   <li><a href="app-ticket.html">Support Ticket</a></li>
                                <li><a href="app-contact.html">Contact / Employee</a></li>
                                <li><a href="app-contact2.html">Contact Grid</a></li>
                                <li><a href="app-contact-detail.html">Contact Detail</a></li>
